...
# Read input files
fp = pd.read_csv('csv/fmri_and_pet_idaSearch_10_07_2014.csv')
fpm = pd.read_csv('csv/fmri_and_pet_and_mri_idaSearch_10_07_2014.csv')
mri = pd.read_csv('csv/mri_idaSearch_10_08_2014.csv')

# Get unique subject ids
f = open('csv/subject_list', 'w+')
...
all_info = pd.read_csv('csv/all_informations_idaSearch_10_06_2014.csv')
